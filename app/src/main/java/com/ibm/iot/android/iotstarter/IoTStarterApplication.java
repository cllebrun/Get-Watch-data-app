...
public class IoTStarterApplication extends Application {
    ...
    private float[] stepCounterDataWatch = new float[1]; // step counter;
    ...
    public float[] getStepCounterDataWatch() { return stepCounterDataWatch; };

    public void setAccelDataWatch(float[] accelDataWatch) {
        this.accelDataWatch = accelDataWatch.clone();
    }
    public void setStepCounterDataWatch(float[] stepCounterDataWatch) {
        this.stepCounterDataWatch = stepCounterDataWatch.clone();
    }
